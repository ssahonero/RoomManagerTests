...
public class DeleteLocationTest {
	...
	public void testSetUp() {
	    ...
	    password = "Control123!";
	    locationName = "Delete Location Test Selenium";
	...
	@Test
	  public void verifyALocationIsDeleted() throws Exception {
		...
		(new WebDriverWait(driver, 30)).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='ng-binding ng-scope']")));
		boolean isRemoved = driver.findElement(By.xpath("//div[@class='ng-binding ng-scope']")).getText().contains("removed");
